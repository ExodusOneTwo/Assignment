...
def loadingStocks():
  ...
  StockIn=input("Please Select Path For Stocks CSV file \n(Locate And Select File: './Your_Location/SSSM.csv'): ")
    ...
    while True:
      ...
      if selection =='1':
        ...
        if len(stockArray) == 0:
          ...
          print ("Please Load Stocks FIRST To Engage With\n")

        else:

          selectedStock=input("Select A Stock To Engage On\n(Select A Stock (Upper Case) :  TEA | POP | ALE | GIN | JOE): ")  
          ...
          if selectedStock in symbolArray:
            ...
            while True:
              ...
              selection=input("Please Select A Function From The Menu: ")
